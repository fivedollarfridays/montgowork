...
**Project:** MontGoWork
**Primary Goal:** Give a Montgomery resident a clear, actionable path from "I can't   get a job" to employment by connecting barrier assessment, credit building tools,   local job matching, and community resources into
