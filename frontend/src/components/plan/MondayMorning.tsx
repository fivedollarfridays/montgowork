    ...
    <section className="space-y-8">
      ...
      <div>
        ...
        <StaggerContainer className="flex flex-wrap justify-center gap-3">
          {steps.map((step, i) => (
            <StaggerItem key={i} className="w-full sm:w-[calc(50%-0.375rem)] lg:w-[calc(33.333%-0.5rem)]">
              <Card className="group flex flex-col h-full transition-shadow duration-300 ease-in-out hover:shadow-md">
